...
def plot(algo_name, n_deg_from, n_deg_to, q_name, data_path, linestyle):
    ...
    for lam_name, color in zip(['logn_div_2', 'logn', 'sqrtn'], ['black', 'red', 'blue']):
...
if __name__ == '__main__':
    algo_name_1 = 'ollga'
    algo_name_2 = 'lea'
    plots_path = '../plots/onemax/normalized/'
    latex_plots_path = '../latex_plots/onemax/normalized/'
    data_path = '../data/onemax/'

    algo_tex_1 = option_tex_parse(algo_name_1)
    algo_tex_2 = option_tex_parse(algo_name_2)
    n_deg_from, n_deg_to = 5, 14
    ...
    for q_name in ['0', 'logn_div_n', '1_div_6e', '1']:
        ...
        name = f'q={q_name}'
        plt.title(f'OneMax function, q={q_tex}')
