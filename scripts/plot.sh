...
python3 plot.py --k 3 --algo_1 ollga --algo_2 lea --algo_3 lea --lam1 sqrtn_div_2 --lam2 1 --lam3 logn --q 0 --fitness jump
python3 plot.py --k 3 --algo_1 ollga --algo_2 lea --algo_3 lea --lam1 sqrtn_div_2 --lam2 1 --lam3 logn --q logn_div_n --fitness jump
python3 plot.py --k 3 --algo_1 ollga --algo_2 lea --algo_3 lea --lam1 sqrtn_div_2 --lam2 1 --lam3 logn --q 1_div_6e --fitness jump
