...
python3 plot.py --algo_1 ollga --algo_2 lea --algo_3 lea --lam sqrtn --q 0 --fitness leading_ones --n_deg_to 10
python3 plot.py --algo_1 ollga --algo_2 lea --algo_3 lea --lam sqrtn --q logn_div_n --fitness leading_ones --n_deg_to 10
python3 plot.py --algo_1 ollga --algo_2 lea --algo_3 lea --lam sqrtn --q 1_div_6e --fitness leading_ones --n_deg_to 10

python3 plot.py --algo_1 ollga --algo_2 lea --algo_3 lea --lam n_div_2 --q 0 --fitness leading_ones --n_deg_to 10
python3 plot.py --algo_1 ollga --algo_2 lea --algo_3 lea --lam n_div_2 --q logn_div_n --fitness leading_ones --n_deg_to 10
python3 plot.py --algo_1 ollga --algo_2 lea --algo_3 lea --lam n_div_2 --q 1_div_6e --fitness leading_ones --n_deg_to 10
