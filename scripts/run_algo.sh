...
python3 main.py --algo lea --n_deg 7 --lam logn --q 1_div_n
python3 main.py --algo lea --n_deg 8 --lam logn --q 1_div_n
python3 main.py --algo lea --n_deg 9 --lam logn --q 1_div_n
python3 main.py --algo lea --n_deg 10 --lam logn --q 1_div_n
python3 main.py --algo lea --n_deg 11 --lam logn --q 1_div_n
python3 main.py --algo lea --n_deg 12 --lam logn --q 1_div_n
python3 main.py --algo lea --n_deg 13 --lam logn --q 1_div_n
python3 main.py --algo lea --n_deg 14 --lam logn --q 1_div_n
